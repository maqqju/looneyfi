...
$('.content').contents().filter(function(index, obj) {
	...
	for (var i = 0; i < Object.keys(map).length; i++) {
		  ...
		  obj.nodeValue = obj.nodeValue.replace(new RegExp(_key, "g"), map[_key]);
	}
});
